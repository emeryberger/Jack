#ifndef YOLOALLOCATOR_H
#define YOLOALLOCATOR_H
...
public:
  ...
  YOLOAllocator()
    : _freedCount (0)
  {
    MESSAGE("You don't know JACK (YOLOAllocator).\n");
  ...
  void free(void * ptr) {
    ...
    if (size <= HL::MmapWrapper::Size) {
      ...
      // Clear it out to enable greater compressibility.  NOTE:
      // optionally can leave freed objects intact to prevent dangling
      // pointer errors.
